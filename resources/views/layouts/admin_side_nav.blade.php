...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">iTec</div>
    </a>
        ...
        <div id="userManagement" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                @if (count(array_intersect(session()->get('grant'), ['SU','users_access']))==1)
                    <a class="collapse-item" href="{{ route('users-management.users') }}">Users</a>
                @endif
                ...
                @if (count(array_intersect(session()->get('grant'), ['SU','permissions_access']))==1)
                    <a class="collapse-item" href="{{ route('users-management.permissions') }}">Permissions</a>
                @endif
            </div>
        </div>
    </li>
